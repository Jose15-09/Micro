; 1. Definimos algunos valores que se a usan en todo el programa
; para no estar escribiendo números a cada rato

.equ N      = 100        ; El arreglo tendrá 100 números
.equ MODVAL = 101        ; Hace que los números aleatorios queden entre 0 y 100

; 2. Memoria RAM
; Se aparta el espacio para guardar arreglos y variables

.dseg

table_of_unsorted_numbers:      .byte N   ; Guarda los 100 números aleatorios sin ordenar
table_of_sorted_numbers_alg1:   .byte N   ; Guarda el arreglo ordenado con Bubble Sort
table_of_sorted_numbers_alg2:   .byte N   ; Guarda el arreglo ordenado con Selection Sort

rng_state:                      .byte 1   ; Variable que guarda el estado del generador de números aleatorios

time_alg1_ticks:                .byte 2   ; Guarda cuánto tiempo tarda Bubble Sort
time_alg2_ticks:                .byte 2   ; Guarda cuánto tiempo tarda Selection Sort

; 3. Código que ejecuta el microcontrolador
